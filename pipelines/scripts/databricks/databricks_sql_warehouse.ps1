...
throw "Sql WareHouse Configuration file not found: $clusterConfigPath"
}
...
$createClusterResponse = Invoke-RestMethod -Uri ($databricksHost + "/api/2.0/sql/warehouses") -Method Post -Headers $databricksHeaders -Body ($clusterBody | ConvertTo-Json -Depth 100)
